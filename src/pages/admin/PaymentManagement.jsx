    ...
    const fetchPayments = async () => {
      try {
        ...
        if (timeRange !== 'all') {
          ...
          filteredPayments = filteredPayments.filter(payment => payment.paymentDate >= cutoffDate);
        }
        ...
        if (filter !== 'all') {
          ...
          if (filter === 'active') {
            filteredPayments = filteredPayments.filter(
              payment => payment.expirationDate && payment.expirationDate > now
            );
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <StatsCard
            ...
            value={payments.filter(p => p.expirationDate && getMembershipStatus(p.expirationDate) === 'active').length}
            icon={
              <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
