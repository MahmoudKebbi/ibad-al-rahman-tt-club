...
import { signIn, signInWithGoogle, signInAsGuest } from '../../services/firebase/auth';
      ...
      <div className="md:w-1/2 flex items-center justify-center p-6 md:p-12">
        <div className="w-full max-w-md">
          ...
          <p className="text-center text-sm text-gray-600 mt-8">
            Don't have an account? <br className="md:hidden" />Contact the club administrator at <a href="tel: +96178761843" className="text-green-600 hover:underline">+961 78 761 843</a> to create one.
          </p>
        </div>
      </div>
    </div>
