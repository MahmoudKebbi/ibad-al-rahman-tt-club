...
const GuestDashboard = () => {
  ...
  const clubSchedule = [
    ...
    { day: 'Wednesday', hours: '18:00 - 21:00', level: 'Beginners & Intermediate' },
  ...
  const clubBenefits = [
    {
      ...
      description: 'Access to certified coaches with years of experience in table tennis.'
    },
    {
      icon: (
        <svg className="h-8 w-8 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      title: 'Community',
      description: 'Join a vibrant community of table tennis enthusiasts of all levels.'
    },
    {
      icon: (
        <svg className="h-8 w-8 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: 'Practice in our well-maintained facility with professional equipment.'
    }
  ];
    ...
    <DashboardLayout>
      <div className="container mx-auto px-4">
        ...
        <div className="bg-gradient-to-r from-green-500 to-green-700 text-white rounded-lg shadow-lg p-6 mb-8">
          <h2 className="text-2xl font-bold mb-2">Welcome to Ibad Al Rahman Table Tennis Club!</h2>
          <p className="text-lg mb-4">Thank you for joining us as a guest.</p>
          <p>As a guest, you can view the club schedule and explore membership options. Consider becoming a member to enjoy all club benefits!</p>
          <Link to="/guest/register">
            <ActionButton  color ="black"
              className="mt-4 bg-tt-black-dark"
            >
              Become a Member
            </ActionButton>
          </Link>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          >
                ...
                <tbody className="divide-y divide-gray-200">
                  {clubSchedule.map((item, index) => (
                    <tr key={index}>
                      ...
                      <td className="px-4 py-3 text-sm text-gray-500">{item.hours}</td>
                      <td className="px-4 py-3 text-sm text-gray-500">{item.level}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <p className="text-sm text-gray-500 mt-4">
              * Schedule may change during holidays or special events. Check with the club for the most up-to-date information.
            </p>
          </ContentCard>
          ...
          >
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              <h4 className="text-lg font-medium text-gray-900">Membership Fees</h4>
              <div className="mt-2 space-y-2">
                <p className="text-sm text-gray-500">
                  <span className="font-medium">Monthly:</span> $50
                </p>
                <p className="text-sm text-gray-500">
                  <span className="font-medium">Quarterly:</span> $135 (Save $15)
                </p>
                <p className="text-sm text-gray-500">
        ...
        <ContentCard noPadding={false}>
          <div className="text-center">
            <h3 className="text-xl font-semibold text-gray-800 mb-4">Ready to Join?</h3>
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Take the next step in your table tennis journey and become a member today. 
