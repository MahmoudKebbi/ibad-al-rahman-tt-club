...
const MemberDashboard = () => {
        ...
        if (profileDoc.exists()) {
          ...
          setMemberProfile({
            ...
            membershipExpiration:
              profileData.membershipExpiration?.toDate() || null,
          ...
          setError(
            "Member profile not found. Please contact the administrator.",
          );
        }
  ...
  const getMembershipUsage = () => {
    ...
    const percentage = Math.min(
      Math.round((daysUsedThisWeek / daysAllowed) * 100),
      100,
    );
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  ...
                  <span className="ml-2">
                    {paymentStatus.status === "paid" ? (
                      <span className="text-green-700">
                        Your membership is active. Next payment due on{" "}
                        {paymentStatus.nextPayment}.
                      </span>
                    ) : paymentStatus.status === "due" ? (
                      <span className="text-yellow-700">
                        Payment of {paymentStatus.amount} due on{" "}
                        {paymentStatus.nextPayment}.
                      </span>
                      ...
                      <span className="text-red-700">
                        Your payment of {paymentStatus.amount} is overdue.
                        Please settle to maintain membership.
                      </span>
                    )}
                  </span>
                </div>
          ...
          <ContentCard>
            <div className="flex items-center">
              <div
                className={`rounded-full p-3 ${currentAttendance ? "bg-green-100 text-green-600" : "bg-blue-100 text-blue-600"}`}
              >
                <svg
                  className="h-6 w-6"
                  fill="none"
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        className={`h-2 rounded-full ${
                          membershipUsage.percentage < 70
                            ? "bg-green-500"
                            : membershipUsage.percentage < 90
                              ? "bg-yellow-500"
                              : "bg-red-500"
                        }`}
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Registration open for the summer tournament starting August
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  We've received new competition-grade tables and nets. Try them
                  out at your next session!
                </p>
              </div>
              <div>
                <p className="text-sm text-gray-800 font-medium">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  10% discount on membership renewals completed before the 25th
                  of each month.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="ml-auto">
                ...
                <p className="font-medium capitalize">
                  {memberProfile.membershipType?.replace(/-/g, " ") ||
