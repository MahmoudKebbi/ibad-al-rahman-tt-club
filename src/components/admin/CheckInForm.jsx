...
import { checkInMember, getCurrentAttendance } from '../../services/firebase/attendance';
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-yellow-700">
                <p>Checked in at: {currentAttendance.checkInTime.toLocaleTimeString()}</p>
                <p>Date: {currentAttendance.checkInTime.toLocaleDateString()}</p>
                {currentAttendance.notes && <p>Notes: {currentAttendance.notes}</p>}
              </div>
            </div>
          </div>
        </div>
    ...
    <ContentCard title="Check In Member">
      ...
      {member && memberProfile && (
        <div className="bg-gray-50 p-4 rounded-md mb-6">
          <h3 className="text-lg font-medium text-gray-800 mb-2">Member Information</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="font-medium">{memberProfile.membershipType || 'None'}</p>
            </div>
            <div>
              <p className="text-sm text-gray-500">Membership Status</p>
              <p className="font-medium">{memberProfile.membershipStatus || 'Inactive'}</p>
            </div>
            <div>
              <p className="text-sm text-gray-500">Weekly Usage</p>
              <p className="font-medium">{memberProfile.daysUsedThisWeek} days used this week</p>
            </div>
            <div>
