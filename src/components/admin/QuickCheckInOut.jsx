            ...
            <div className="mt-4 border rounded-md divide-y">
              {searchResults.map((member) => (
                ...
                >
                  ...
                  <div>
                    <ActionButton size="sm" color="green">
                      Select
                    </ActionButton>
                  </div>
                </div>
        ...
        <div>
          <div className="bg-gray-50 p-4 rounded-md mb-6">
            <div className="flex justify-between items-center">
              ...
              <ActionButton size="sm" color="gray" onClick={handleReset}>
                Change Member
              </ActionButton>
            </div>
          </div>
            ...
            <div>
              <div className="mb-4 bg-blue-50 p-4 rounded-md">
                <p className="text-blue-700">
                  This member is currently checked in since{" "}
                  {new Date(currentAttendance.checkInTime).toLocaleTimeString()}{" "}
                  on{" "}
                  {new Date(currentAttendance.checkInTime).toLocaleDateString()}
                  .
                </p>
              </div>
            ...
            <div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <SelectField
                  ...
                  options={[
                    {
                      value: AttendanceType.REGULAR,
                      label: "Regular Training",
                    },
                    {
                      value: AttendanceType.COACHING,
