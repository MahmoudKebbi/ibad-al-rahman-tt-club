              ...
              >
                  ...
                  daySessions.map((session, idx) => (
                    <div 
                      ...
                      className={`mb-2 p-2 rounded-md text-xs border-l-4 
                        ${session.type === 'advanced' ? 'bg-purple-50 border-purple-500' : 
                          session.type === 'beginner' ? 'bg-blue-50 border-blue-500' : 
                    ...
                    >
                      ...
                      <div className="text-gray-500">Coach: {session.coach}</div>
                ...
                {userRole === 'admin' && (
                  <Link to={`/admin/schedule/create?date=${day.formattedDate}`}>
                    <button 
                      className="w-full mt-2 py-1 text-xs text-center text-gray-500 hover:text-green-600 border border-dashed border-gray-300 rounded-md hover:border-green-500"
                    >
                      + Add Session
                    </button>
                  </Link>
